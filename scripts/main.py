...
def main():
  ...
  params = {'catagory':'food', 'location':'portland,or97266', 'limit': '50', 'offset': '0', 'radius':40000}
  req = requests.get(url, params = params, headers = headers)
  data = json.loads(req.text)

  for offs in range(1, 20):
    params = {'catagory':'food', 'location':'portland,or97266', 'radius': 40000, 'limit': '50', 'offset': (offs*50)}
    req = requests.get(url, params = params, headers = headers)
